...
settings = {'name': 'MCMC',  # name with which your results and figures will start
            ...
            'components': {'synchrotron': 0,    # synchrotron emission
                           'freefree': 0,       # free-free emission
                           'ame': 0,            # anomalous microwave emission
                           'cmb': 0,            # cmb anisotropies
                           'thermaldust': 0,    # thermal dust emission
            ...
            'plotting': {'resultdir': '',      # results save directory
                         'plotdir': '',        # figure save directory
